...
class Channel {
  ...
  async rpc(callId, interfaceName, methodName, args) {
    ...
    this.application.console.log({ callId, interfaceName, methodName, args });
    ...
    let result = null;
    try {
      this.application.console.log({ context, args });
  ...
  startSession() {
    ...
    const host = utils.parseHost(this.req.headers.host);
  ...
  async restoreSession() {
    ...
    const cookies = utils.parseCookies(cookie);
    const { token } = cookies;
